...
def read_radiant_txt(file, measured_charge=True, return_meta_data=False, delimiter=','):
    """Load a radiant data file (typically as generated from quicklook functions). If retrieving a hysteresis file, one would typically use 'True' for measured_charge unless one accurately measured capacitor area and input correctly into the Radiant UI.
